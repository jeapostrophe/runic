...
int main(void)
{
	...
	printf("%lld\n", r.sb.st_size); // off_t is entirely dependent on the implementation for size
									// some implementations it is int32_t, others it is int64_t.
									// In this case it is 64.
									// see: https://stackoverflow.com/questions/9073667
